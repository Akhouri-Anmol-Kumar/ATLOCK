...
![Download Latest Release](https://img.shields.io/github/v/release/AkhouriAnmolKumar/ATLOCK?style=for-the-badge&color=c9b97a&labelColor=0a0a0a&label=⬇️%20DOWNLOAD%20ATLOCK)
<sub>(Replace the repo path in the badge above with your actual GitHub username/repo)</sub>
</div>
---
🧭 What is ATLOCK?
...
📦 Installation
```
1. Download the .exe from the Releases page (or click the button above)
2. Extract (if zipped)
3. Run ATLOCK_v4.exe
```
